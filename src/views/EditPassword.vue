    ...
    <div class="grow flex flex-col justify-between gap-4 pb-20">
      <form class="flex flex-col gap-4">
        ...
        <div class="grid gap-2">
          ...
          <input class="drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)] rounded-full p-2 text-lg" type="password" name="actual_password" id="actual_password">
        </div>
        <div class="grid gap-2">
          <label class="text-left font-bold" for="name">Nouveau mot de passe : </label>
          <input class="drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)] rounded-full p-2 text-lg" type="password" name="nom" id="nom">
        </div>
        <div class="grid gap-2">
      ...
      <div class="grid gap-4">
        ...
        <button class="drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)] bg-white p-2 rounded-full text-neutral-900 font-bold">Retour</button>
      </div>
    </div>
  </div>
  <navbar/>
