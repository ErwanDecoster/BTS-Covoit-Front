    ...
    <div class="logo pt-6">
      ...
      <form @submit.stop.prevent="AddRegistration" class="flex flex-col gap-4">
        ...
        <div class="grid gap-2">
          ...
          <input v-model="tel" class="drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)] rounded-full p-2 text-lg" type="text" name="tel" id="tel" autocomplete="tel">
        </div>
        <div class="grid gap-2">
          <label class="text-left font-bold" for="new_password">Mot de passe : </label>
          <input v-model="password" class="drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)] rounded-full p-2 text-lg" type="password" name="new_password" id="new_password" autocomplete="new-password">
        </div>
        <div class="grid gap-2">
          <label class="text-left font-bold" for="new_retipe_password">Confirmation de mot de passe : </label>
          <input v-model="password_confirmed" class="drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)] rounded-full p-2 text-lg" type="password" name="new_retipe_password" id="new_retipe_password" autocomplete="new-password">
        </div>
